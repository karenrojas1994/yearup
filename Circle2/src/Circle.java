...
double m_radius = -1;
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Big cirlce's radius is " + bigCircle.m_radius);
		System.out.println("Big circle's color is " + bigCircle.m_color);
		System.out.println("Big cirlce's area is " + bigCircle.CalculateArea());
		bigCircle.PrintColor();
		
		Circle smallCircle = new Circle(3, "pink");
		System.out.println("Small cirlce's radius is " + smallCircle.m_radius);
		System.out.println("Small circle's color is " + smallCircle.m_color);
		
		double areaofSmallCircle = smallCircle.CalculateArea();
		System.out.println("Small cirlce's area is " + areaofSmallCircle);
